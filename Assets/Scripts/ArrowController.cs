...
public class ArrowController : MonoBehaviour
{
    ...
    [SerializeField] SpriteRenderer backgroundTargets;
    ...
    void prepareLevel1()
    {
        ...
        */
        ...
        prefabTarget.transform.parent = subsetGame.transform;
                    ...
                    case "Round: 3/3":
                        if (insideTarget)
                        {
                            ...
                            if (l3targets == 0)
                            {
                                ...
                                //Victory screen?
                                Debug.Log("VICTORY");
                                subsetGame.transform.GetChild(0).gameObject.GetComponent<SpriteRenderer>().enabled = false;
                                subsetGame.transform.GetChild(1).gameObject.GetComponent<SpriteRenderer>().enabled = false;
                                ...
                                instructions.text = "Press \"SPACE\" to\ncontinue";
